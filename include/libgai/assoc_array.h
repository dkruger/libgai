...
/**
 * Associates the given @a value with the given @a name in the @a array
 *
 * Both @a name and @a value will deeply copied before storing in the @a array.
 *
 * Calling this method with the same @a name will overwrite the previous
...
/**
 * Retrieves the value from the stored in the @a array with the given @a name.
 *
 * If there is no associated value, then NULL will be returned.
 *
 * @return The value associated with the name in the array, or NULL if no value
 *         was found.
 */
